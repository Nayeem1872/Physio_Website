      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              Sign in to Reflex Physiotherapy & Rehab Center
            </motion.p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-300 text-[#2e3192] focus:ring-[#2e3192]"
                />
                <span className="text-sm text-gray-600">Remember me</span>
              </label>
              <Link
                href="/forgot-password"
                className="text-sm text-[#2e3192] hover:text-[#4c46a3] font-medium transition-colors"
              >
                Forgot Password?
              </Link>
            </motion.div>
            ...
            >
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-[#2e3192] to-[#4c46a3] hover:from-[#2e3192]/90 hover:to-[#4c46a3]/90 text-white py-6 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
